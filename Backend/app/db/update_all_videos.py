...
# (cycling if a course has more lessons than curated videos).
COURSE_VIDEOS = {
    "curso-profesional-javascript": [
        ...
        "https://www.youtube.com/watch?v=1glVfFxj8a4",  # JS completo moderno
    ],
    "curso-python-desde-cero": [
        ...
        "https://www.youtube.com/watch?v=Kp4Mvapo5kc",  # Curso COMPLETO Python
    ],
    "curso-react-profesional": [
        ...
        "https://www.youtube.com/watch?v=qkzcjwnueLA",  # React videojuego
    ],
    "curso-backend-nodejs": [
        "https://www.youtube.com/watch?v=tDF644vI-gs",  # jonmircha - Node + Express
        "https://www.youtube.com/watch?v=isPMA0FWwJA",  # API REST con Node desde cero
    ],
    "curso-inteligencia-artificial-python": [
        "https://www.youtube.com/watch?v=xyU2pzKTQE0",  # Adrian Cancino - ML completo
        "https://www.youtube.com/watch?v=QbDcJUVXpxA",  # ML con Python - Data Science
    ],
    "curso-diseno-ux-ui": [
        ...
        "https://www.youtube.com/watch?v=TXmQ3D4OIUA",  # Guía rápida UX
    ],
    "curso-devops-cloud": [
        ...
        "https://www.youtube.com/watch?v=Vgm9FSM0jlk",  # Kubernetes conceptos
        "https://www.youtube.com/watch?v=Sccd454SgWk",  # Kubernetes arquitectura
    ],
    "curso-bases-datos-sql-nosql": [
        ...
        "https://www.youtube.com/watch?v=8N4M994IDt8",  # SQL y BD 8 horas
    ],
    "curso-typescript-avanzado": [
        "https://www.youtube.com/watch?v=qObAEqBEKHI",  # Curso TypeScript sesión 1+
        "https://www.youtube.com/watch?v=7XRyVqPpBi0",  # TS desde cero - instalación
        "https://www.youtube.com/watch?v=4lAYfsq-2TE",  # React + TypeScript práctico
    ],
    ...
    "curso-vuejs-3-desde-cero": [
        "https://www.youtube.com/watch?v=KdfrY2GYuTo",  # Vue curso COMPLETO (5h)
    ],
    "curso-ciberseguridad": [
        ...
        "https://www.youtube.com/watch?v=lUr9C05NfPM",  # Pentesting completo
    ],
    "curso-flutter-dart": [
        "https://www.youtube.com/watch?v=IKG1eV2SetA",  # AristiDevs - Flutter/Dart (9h)
    ],
    "curso-blockchain-web3": [
        "https://www.youtube.com/watch?v=bN3seZiVJmk",  # Fazt - Desarrollo Blockchain
        "https://www.youtube.com/watch?v=syFww00o7ug",  # Foundry - desplegar contratos
        "https://www.youtube.com/watch?v=EWXy3ov5KVY",  # Solidity - mappings
    ],
    # NOTE: no high-quality Spanish R-specific course surfaced during curation;
    # assigned the Data-Science-themed ML course as interim content.
    "curso-data-science-r": [
        "https://www.youtube.com/watch?v=QbDcJUVXpxA",  # ML/Data Science (interim)
    ],
}
...
def apply_real_videos() -> None:
    ...
    try:
        updated_courses = 0
        for slug, urls in COURSE_VIDEOS.items():
            ...
            db.commit()
            updated_courses += 1
            print(f"[ok] {slug}: {changed}/{len(lessons)} lessons set ({len(urls)} curated videos)")
